<template>
    <div class="learning-vue-part3">
        <h2>Компоненты</h2>
        <h3>Подключение компонентов</h3>
        <p>
            Компоненты можно поключать как локально, импортируя дочерние компоненты в родительском
            и регистрируя их в поле components, так и глобально импортируя их в основном файле .js,
            там где рендерится родительский компонент и подключать их там же через
            <strong>Vue.component('name component', component ), где component - это переменная из импорта</strong>.
        </p>
